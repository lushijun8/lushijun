...
namespace Entity.CHANNELSALES_STATS
{
    ...
    /// DataBase="CHANNELSALES_STATS" 
    /// Table="REQUEST_LOG"
    /// Columns="ID,PAGEURL,REQUESTURL,HTTPSTATUSCODE,CONTENTTYPE,CONTENTLENGTH,CONTENT,TIMEOUT,TIMESPAN,CREATETIME"
    /// PrimaryKeys="ID"
    /// </summary>
    public sealed class REQUEST_LOG : Entity.CHANNELSALES_STATS.EntityBase
    {
        #region 系统生成代码，请不要动 生成日期:2016/7/28 11:04:51
        #region 属性
        /// <summary>
        ///   INT(4) 自增列 NOT NULL
        ...
        /// <summary>
        ///    INT(4)  NULL
        ///	只写属性，如果非要读取该字段的字符串,建议使用 TIMEOUT_ToString 更加准确
        /// </summary>
        public int TIMEOUT
        {
            set
        ...
        /// <summary>
        ///    INT(4)  NULL
        ///	只读属性，如果非要写入该字段，请使用 TIMEOUT
        /// </summary>
        public string TIMEOUT_ToString
        {
            get
            {
        ...
        /// <summary>
        ///   返回 "TIMEOUT", 为了与数据库同步，避免列名写错，如果用到表的列名，请尽量使用同名列变量
        /// </summary>
        public readonly string _TIMEOUT = "TIMEOUT";
        /// <summary>
        ...
        public REQUEST_LOG()
        {
            ...
            this.columns = new string[] { _ID, _PAGEURL, _REQUESTURL, _HTTPSTATUSCODE, _CONTENTTYPE, _CONTENTLENGTH, _CONTENT, _TIMEOUT, _TIMESPAN, _CREATETIME };
        ...
        protected override void SetValuesOnInit()
        {
            if (this.DataTypes == null || this.DataTypes.Length == 0)
            {
                ...
                this.DataTypes = new string[] { INT, NVARCHAR, NVARCHAR, NVARCHAR, NVARCHAR, INT, TEXT, INT, FLOAT, DATETIME };
                this.Lengths = new int[] { 4, 2048, 2048, 100, 100, 4, 16, 4, 8, 8 };
        ...
        */
        ...
        /*
                ...
                CREATE TABLE [dbo].[REQUEST_LOG](
                 ...
                 [PAGEURL] [NVARCHAR]  (1024)  COLLATE Chinese_PRC_CI_AS  NULL ,
                 [REQUESTURL] [NVARCHAR]  (1024)  COLLATE Chinese_PRC_CI_AS  NULL ,
                 [HTTPSTATUSCODE] [NVARCHAR]  (50)  COLLATE Chinese_PRC_CI_AS  NULL ,
                 [CONTENTTYPE] [NVARCHAR]  (50)  COLLATE Chinese_PRC_CI_AS  NULL ,
                 [CONTENTLENGTH] [INT]  NULL ,
                 [CONTENT] [TEXT]  COLLATE Chinese_PRC_CI_AS  NULL ,
                 [TIMEOUT] [INT]  NULL ,
                 [TIMESPAN] [FLOAT]  (8)  NULL ,
