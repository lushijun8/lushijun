...
{
    public partial class Job_Delete : Business.ManageWeb
    {
        ...
        {
            this.AdminCheck("Manager/Job/Job_Delete.aspx");
        ...
        private void BindData()
        {
            if (this.P_TYPE == "0")
            {
                ...
                if (tuantaskautorun.Delete() == false)
                {
