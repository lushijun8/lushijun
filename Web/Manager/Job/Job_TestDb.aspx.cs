...
{
    public partial class Job_TestDb : Business.ManageWeb
    {
        ...
        {
            this.AdminCheck("Manager/Job/Job_TestDb.aspx");
        ...
        private void BindData()
        {
            if (this.P_TYPE == "0")
            {
                ...
                tuantaskautorun.TESTDB = 1;
                tuantaskautorun.TESTDB_REMARK = "";
