...
{
    public partial class Share_Article_List_My : Business.ManageWeb
    {
        ...
        {
            this.AdminCheck("Manager/Share/Share_Article_List_My.aspx");
        ...
        private void BindData()
        {
            ...
            share_article_good.CacheTime = 30;
            ...
            page.Url = Business.Config.HostUrl + "/Manager/Share/Share_Article_List_My.aspx?page={page}&orderby=" + Server.UrlEncode(this.P_OrderBy);
