...
{
    public partial class DataBase_My_Sql_Ignore_Delete : Business.ManageWeb
    {
        protected string P_Sql_Md5 = "";
        protected string P_BackUrl = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            this.AdminCheck("Manager/Sql/DataBase_My_Sql_Ignore_Delete.aspx");
        ...
        private void BindData()
        {
            ...
            if (database_sql_my_ignore.Delete() == true)
            {
                #region 删除首页缓存
                for (int i = 0; i <= 25; i++)
                {
