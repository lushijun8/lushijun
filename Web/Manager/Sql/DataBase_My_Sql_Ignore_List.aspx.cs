...
{
    public partial class DataBase_My_Sql_Ignore_List : Business.ManageWeb
    {
        ...
        {
            this.AdminCheck("Manager/Sql/DataBase_My_Sql_Ignore_List.aspx");
        ...
        private void BindData()
        {
            ...
            database_sql_my_ignore.WhereSql = database_sql_my_ignore.TableName + "." + database_sql_my_ignore._WEBMANAGER_NAME + "='" + (this.QueryString("v") == "" ? this.CurrentWebManagerName : this.QueryString("v")) + "'";
            ...
            page.Url = Business.Config.HostUrl + "/Manager/Sql/DataBase_My_Sql_Ignore_List.aspx?page={page}&keyword=" + Server.UrlEncode(this.txtKeyword.Text) + "&orderby=" + Server.UrlEncode(this.P_orderby);
