...
{
    public partial class Task_List_My : Business.ManageWeb
    {
        ...
        {
            this.AdminCheck("Manager/Task/Task_List_My.aspx");
        ...
        private void BindData()
        {
            ...
            task.TASK_WEBMANAGER_NAME = this.CurrentWebManagerName;
            ...
            page.Url = Business.Config.HostUrl + "/Manager/Task/Task_List_My.aspx?page={page}&orderby=" + Server.UrlEncode(this.P_OrderBy) + "&Task_Finished="+this.P_Task_Finished;
            ...
            outPage = page.Page();
            //====================================================
            this.LogCount_finished = int.Parse(task.Database_Writer.ExecuteDataSet(CommandType.Text, "select count(1) from task where task_finished=1 and task_webmanager_name='"+this.CurrentWebManagerName+"'").Tables[0].Rows[0][0].ToString());
