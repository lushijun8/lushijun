<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataBase_Owner_Add.aspx.cs" Inherits="Web.Manager.DataBase.DataBase_Owner_Add" %>
                    ...
                    <td class="c2">
                            ...
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button CssClass="button" ID="btnSubmit" runat="server" Text="确认添加" OnClick="btnSubmit_Click" />
                                        <font color="red">
