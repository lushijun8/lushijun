...
{
    public partial class WebSite_My_PageUrl_List : Business.ManageWeb
    {
        ...
        {
            this.AdminCheck("Manager/WebSite/WebSite_My_PageUrl_List.aspx");
        ...
        private void BindData()
        {
            ...
            website_my_pageurl.WEBMANAGER_NAME = (this.QueryString("v") == "" ? this.CurrentWebManagerName : this.QueryString("v"));
            string wheresql = " 1=1 ";
            if (!string.IsNullOrEmpty(this.txtKeyword.Text))
            {
                wheresql += " AND " + website_my_pageurl.TableName + "." + website_my_pageurl._PAGEURL + " LIKE '%" + this.txtKeyword.Text + "%' ";
            }
            //wheresql += " AND STATS_DATE = '" + this.P_Today + "' ";
            website_my_pageurl.WhereSql = wheresql;
            //website_my_pageurl.LEFT_JOIN_DATABASE_SQL_CONNECT_STATS = true;
            ...
            website_my_pageurl.SelectColumns = new string[] { 
                ...
                "" + website_my_pageurl.TableName  + "." + website_my_pageurl._QUERYSTRING_PHONE_ENCRYPT, 
                "" + website_my_pageurl.TableName  + "." + website_my_pageurl._FORM_PHONE_ENCRYPT, 
                "" + website_my_pageurl.TableName  + "." + website_my_pageurl._FORM, 
                "" + website_my_pageurl.TableName  + "." + website_my_pageurl._QUERYSTRING, 
                "" + website_my_pageurl.TableName + "." + website_my_pageurl._CREATETIME, 
                "request_count",
                "connect_times_min",
                "connect_times_max",
                "connect_times_avg",
