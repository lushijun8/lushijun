...
namespace Business
{
    public class PageUrlAnalysis
    {
        public static void Match(string MyPageUrl)
        {
            ...
            website_my_domain.CacheTime = 60;
            ...
            if (!string.IsNullOrEmpty(MyPageUrl))
            {
                website_depend.WhereSql = "(" + website_depend._PAGEURL + "='" + MyPageUrl + "' OR " + website_depend._DEPEND_PAGEURL + "='" + MyPageUrl + "')";
            }
            ...
            foreach (DataRow oDr_website_pageurl in oDt_website_pageurl.Rows)
            {
                ...
                oDr_website_pageurl[website_pageurl._WEBMANAGER_NAME] = "";
                oDr_website_pageurl[website_pageurl._WEBMANAGER_REALNAME] = "";
                oDr_website_pageurl[website_pageurl._WEBMANAGER_NAME_LIKE] = "";
                oDr_website_pageurl[website_pageurl._WEBMANAGER_REALNAME_LIKE] = "";
                oDr_website_pageurl[website_pageurl._ISMY_CREATETIME] = "";
