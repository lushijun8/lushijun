...
namespace Com.Net
{
    public class TelnetUtil
    {
        ...
        /// <param name="CommandTimeout">秒</param>
        public TelnetUtil(string Address, int Port, int CommandTimeout)
        {
            address = Address;
            port = Port;
        ...
        public bool Connect()
        {
            ...
            try
            {
                Match match = Regex.Match(address, @"[a-z]", RegexOptions.IgnoreCase | RegexOptions.Multiline);
                if (match.Success)
                {
        ...
        private void RespondToOptions()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(m_strResp))
                {
